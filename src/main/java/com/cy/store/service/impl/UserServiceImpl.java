...
/** 用户模块业务层的实现类 **/
@Service // @Service注解：将当前类的对象交给Spring来管理，自动创建对象以及类的维护
public class UserServiceImpl implements IUserService {
    ...
    public void reg(User user) {
        ...
        // 调用UserMapper的findByUsername（username）判断用户是否被注册过
        ...
        // 密码加密处理的实现：MD5算法的形式:67kjsjfj-684kjkjfk-skjkfid-jfskjfk-trjkjf0-454jkljfdsf
    ...
    public void changeInfo(Integer uid, String username, User user) {
        ...
        if (rows != 1){
            throw new UpdateException("更新是产生未知的异常");
        }
    }
